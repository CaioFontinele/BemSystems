...
const Navbar = () => {
  return (
    <div className="navbar bg-black-800 opacity-80 backdrop-blur-lg rounded-3xl bg-none font-Thasadith font-bold">
      ...
      <div className="navbar-start">
        <div className="drawer flex transition-all duration-500">
          ...
          <a className="btn btn-ghost normal-case ml-10"><img src={Logo.src}></img></a>

          <div className="drawer-side ">
            <label htmlFor="my-drawer" aria-label="close sidebar" className="drawer-overlay "></label>
            <ul className="menu p-4 w-80  z-20 min-h-full bg-black-800 backdrop-blur-xl text-black-200 text-lg tracking-wide items-center">
      ...
      <div className="navbar-end mr-20 font-Thasadith font-thin sm:hidden md:flex lg:flex max-sm:hidden text-black-50">
        <ul className="menu menu-horizontal px-1 flex-nowrap text-lg tracking-wide">
          <li><a className='hover:bg-orange-500 hover:text-black-900'>Quem somos</a></li>
          <li><a className='hover:bg-orange-500 hover:text-black-900'>Serviços</a></li>
          <li><a className='hover:bg-orange-500 hover:text-black-900'>Destaques</a></li>
          <li><a className='hover:bg-orange-500 hover:text-black-900'>Espaços</a></li>
